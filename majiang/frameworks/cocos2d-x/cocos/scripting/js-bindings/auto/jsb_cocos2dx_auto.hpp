...
bool js_cocos2dx_Grid3D_getOriginalVertex(JSContext *cx, uint32_t argc, jsval *vp);
bool js_cocos2dx_Grid3D_createTurnPage(JSContext *cx, uint32_t argc, jsval *vp);
bool js_cocos2dx_Grid3D_calculateHorizontalVertexPoints(JSContext *cx, uint32_t argc, jsval *vp);
bool js_cocos2dx_Grid3D_setVertex(JSContext *cx, uint32_t argc, jsval *vp);
