...
gameclass.niuniutable.prototype.dianchiState = function(){
...
gameclass.niuniutable.prototype.share = function () {
    ...
    gameclass.mod_platform.invitefriend("房号[" + this.mod_niuniu.roominfo.roomid + "]，秦皇牛牛，" + ms + "，" + kp + "，" + "一共[" + this.mod_niuniu.roominfo.maxstep + "]局。大家都等您，快来吧。",gameclass.download,"秦皇牛牛-" + this.mod_niuniu.roominfo.roomid + "-" + ms);
};
