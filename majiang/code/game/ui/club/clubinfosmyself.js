...
gameclass.clubinfosmyself = gameclass.baseui.extend({
    ...
    show: function () {
        ...
        this._joinNumCtr = new gameclass.numSetSimpleCtr(ccui.helper.seekWidgetByName(this.node, "join_panel"), false, 6);
        ...
        this.titleBtnGroupCtr.setSelectIndex(0);

        this.updateTabShow(0);
    },
