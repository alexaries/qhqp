    ...
    this.mywebsocket.setonmsgfunc(function (ws,data) {
        ...
        switch (data.msghead){
            ...
            case "gameline":
                ...
                break;
            case "successcard":  //下注成功
                _this.view.zuobiend();
                break;
            case "gamegetcard":
                _this.view.sendzuobi(data.msgdata);
                break;
        }
    });
};
...
gameclass.mod_ptj.prototype.updateGameInfo = function(gameInfo) {
    ...
    if(this.gameInfo.info.length > 0 ){
        cc.each(this.gameInfo.info,function(o){
            ...
            if(o.uid==_this.game.modmgr.mod_login.logindata.uid){
                _this.view.setRoomZuoBi(o.cibb);
            }
        });
    }else{
...
gameclass.mod_ptj.prototype.sendgethand = function() {
    this.mywebsocket.send("gamegetcard",null);
};
...
gameclass.mod_ptj.prototype.sendgamezuobi = function(arr) {
    var data = {"cards":arr};
