...
gameclass.numSetSimpleCtr = cc.Class.extend({
    ...
    initView: function () {
        ...
        for (var i = 0; i < this._maxLen; i++) {
            ...
            if (this._isImgShow) {
                ...
                numShowChild = new cc.LabelTTF("", "Arial", 42);
                // numShowChild.fontSize = 42;
            }
    ...
    setFont:function (fontSize, color) {
        for(var i = 0;i<this._numShowContain.getChildrenCount();i++){
            var child = this._numShowContain.getChildren()[i];
